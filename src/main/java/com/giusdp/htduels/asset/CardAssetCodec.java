...
public class CardAssetCodec implements AssetCodec<String, CardAsset> {
    ...
    @Override
    public CardAsset decodeAndInheritJsonAsset(RawJsonReader reader, CardAsset parent, AssetExtraInfo<String> extraInfo) throws IOException {
    ...
    @Nullable
    @Override
    public CardAsset decodeAndInheritJson(RawJsonReader reader, CardAsset parent, ExtraInfo extraInfo) throws IOException {
        return decodeJson(reader, extraInfo);
    }

    @Override
    public void decodeAndInheritJson(RawJsonReader reader, CardAsset parent, CardAsset target, ExtraInfo extraInfo) throws IOException {
    }
    ...
    public CardAsset decode(BsonValue value, ExtraInfo extraInfo) {
        ...
        return new CardAsset(
                ID.getNow(doc, extraInfo),
                NAME.getNow(doc, extraInfo),
                COST.getNow(doc, extraInfo),
                ATTACK.getNow(doc, extraInfo),
                HEALTH.getNow(doc, extraInfo),
                TYPE.getNow(doc, extraInfo)
        );
    }
