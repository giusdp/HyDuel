...
public class BoadGameUI extends InteractiveCustomUIPage<BoadGameUI.BindingData> {

    public BoadGameUI(@Nonnull PlayerRef playerRef, @Nonnull CustomPageLifetime lifetime) {
