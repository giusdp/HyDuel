...
class DuelSetupServiceTest {
    ...
    class CreateBoardLayoutTests {
        ...
        void noneRotationOffsetsZByHalf() {
            BoardLayout layout = DuelSetupService.createBoardLayout(new Vector3i(10, 5, 20), Rotation.None);
        ...
        void ninetyRotationOffsetsXByHalfAndZByOne() {
            BoardLayout layout = DuelSetupService.createBoardLayout(new Vector3i(10, 5, 20), Rotation.Ninety);
            Vec2f origin = layout.boardOrigin();
        ...
        void oneEightyRotationOffsetsXByOneAndZByHalf() {
            BoardLayout layout = DuelSetupService.createBoardLayout(new Vector3i(10, 5, 20), Rotation.OneEighty);
            Vec2f origin = layout.boardOrigin();
        ...
        void twoSeventyRotationOffsetsXByHalf() {
            BoardLayout layout = DuelSetupService.createBoardLayout(new Vector3i(10, 5, 20), Rotation.TwoSeventy);
            Vec2f origin = layout.boardOrigin();
            assertEquals(10.5f, origin.x, 0.001f);
        ...
        void rotationIsPreserved() {
            BoardLayout layout = DuelSetupService.createBoardLayout(new Vector3i(0, 0, 0), Rotation.Ninety);
    ...
    class CalculateCameraPositionTests {
        ...
        void noneRotationCentersOnZ() {
            Position pos = DuelSetupService.calculateCameraPosition(new Vector3i(10, 5, 20), Rotation.None);
        ...
        void ninetyRotationCentersOnXAndZ() {
            Position pos = DuelSetupService.calculateCameraPosition(new Vector3i(10, 5, 20), Rotation.Ninety);
        ...
        void oneEightyRotationCentersOnXAndZ() {
            Position pos = DuelSetupService.calculateCameraPosition(new Vector3i(10, 5, 20), Rotation.OneEighty);
        ...
        void twoSeventyRotationCentersOnX() {
            Position pos = DuelSetupService.calculateCameraPosition(new Vector3i(10, 5, 20), Rotation.TwoSeventy);
            assertEquals(10.5, pos.x, 0.001);
            assertEquals(5 + 1.75, pos.y, 0.001);
        ...
        void yOffsetIsConsistent() {
            for (Rotation r : Rotation.values()) {
                Position pos = DuelSetupService.calculateCameraPosition(new Vector3i(0, 10, 0), r);
