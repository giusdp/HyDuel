...
class CardInteractionServiceTest {
    ...
    private DuelistSessionManager.DuelSpatialData spatialData(Position cameraPos, float cameraYaw, float cardY) {
        return new DuelistSessionManager.DuelSpatialData(cameraPos, cameraYaw, cardY);
    }
