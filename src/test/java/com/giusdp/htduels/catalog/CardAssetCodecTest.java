...
class CardAssetCodecTest {
    ...
    void decodeCardFromBsonDocument() {
        BsonDocument doc = new BsonDocument().append("Id", new BsonString("Fireball"))
                .append("Name", new BsonString("Fireball")).append("Cost", new BsonInt32(4))
                .append("Attack", new BsonInt32(0)).append("Health", new BsonInt32(0))
