...
class DuelSessionTest {
    ...
    class DuelSpatialDataTests {
        ...
        void storesCameraPosition() {
            ...
            var spatial = new DuelSession.DuelSpatialData(cameraPos, 1.5f, 3f);
        ...
        void storesCameraYaw() {
            ...
            var spatial = new DuelSession.DuelSpatialData(cameraPos, expectedYaw, 3f);
        ...
        void storesCardY() {
            ...
            var spatial = new DuelSession.DuelSpatialData(cameraPos, 0f, expectedCardY);
        ...
        void cameraHeightCalculation() {
            ...
            var spatial = new DuelSession.DuelSpatialData(cameraPos, 0f, 3f);
